      ...
      for (var k = 0; k < batches.length; k++) {
        ...
        (function(kk) {
          directionsService.route(request, function(result, status) {
            ...
            legend.innerHTML = "<tr class='rowheader'><td>Stop</td><td>Arrival Time</td><td>Start Address</td><td>End Address</td><td>Distance</td></tr>";
          ...
          //postal code - stops[i].properties.location_name
				   legend.innerHTML += "<tr><td>"+i+"</td><td>"+stops[i].properties.arrival_time+"</td><td>("+stops[i].properties.location_name+")<br><br>"+legs[i].start_address +"</td><td>("+stops[i+1].properties.location_name+")<br><br>"+legs[i].end_address+"</td><td>"+legs[i].distance.text+"</td></tr>";
...
function createMarker(map, latlng, label, html) {
  ...
  //console.log(label);
  var contentString = '' + label + '<br>' + html;
