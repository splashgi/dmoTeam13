      ...
      for (var k = 0; k < batches.length; k++) {
        ...
        (function(kk) {
          directionsService.route(request, function(result, status) {
            ...
            legend.innerHTML = "<tr class='rowheader'><td><b>Stop</b></td><td><b>Arrival Time</b></td><td><b>Start Address</b></td><td><b>End Address</b></td><td><b>Distance</b></td></tr>";
          ...
          //postal code - stops[i].properties.location_name
				   legend.innerHTML += "<tr><td>"+i+"</td><td><b>"+stops[i].properties.arrival_time+"</b></td><td><b>("+stops[i].properties.location_name+")<br><br>"+legs[i].start_address +"</b></td><td><b>("+stops[i+1].properties.location_name+")<br><br>"+legs[i].end_address+"</b></td><td><b>"+legs[i].distance.text+"</b></td></tr>";
